...
let inputs = [[2, 4], [-3, 3], ['hi', 'man'], [2, 3], [7, 3], [4, 1], [9, 0, 0]];

let outputs = [6, 0, undefined, 5, 10, 5, undefined];
...
*/
function f(input) {
  if (!Array.isArray(input) || input.length !== 2 || typeof input[0] !== 'number' || typeof input[1] !== 'number') return undefined;
